...
procedure TFormPrincipal.SSW1Click(Sender: TObject);
begin
  FormConsultaOcorrenciaSSW := TConsultaOcorrenciaSSW.Create(Self);
  try
    FormConsultaOcorrenciaSSW.ShowModal;
  finally
    FormConsultaOcorrenciaSSW.Free; // Libera a memória usada
  end;
end;
